...
d = c(1, 3, NA, 5, 6, 9)
d = d[!is.na(d)]
abs(mean(d) - 1/length(d)*sum(d)) < 0.01
...
a = replicate(10, g())
if(as.logical(a) && sum(as.logical(a)) > 0){
...
i = 'https://imgs.xkcd.com/comics/temperature_preferences.png'
download.file(i,'i.png', mode='wb')
jj <- readPNG('i.png', native = TRUE)
